!(function (t) {
  ...
  function (t, e) {
    ...
    var r = Object.freeze({
      ...
      mergeStreams: function (t, e, i) {
        ...
        for (; t.length || e.length; ) {
          var g = h();
          if (
            ((r += n(i.substring(s, g[0].offset))), (s = g[0].offset), g === t)
          ) {
            o.reverse().forEach(c);
            do {
              d(g.splice(0, 1)[0]), (g = h());
    ...
    const g =
      ...
      y = b("/\\*", "\\*/"),
      x = b("#", "$"),
      v = { className: "number", begin: "\\b\\d+(\\.\\d+)?", relevance: 0 },
      S = { className: "number", begin: g, relevance: 0 },
      P = { className: "number", begin: "\\b(0b[01]+)", relevance: 0 },
      E = {
        className: "number",
        begin:
      ...
      I = { className: "title", begin: "[a-zA-Z]\\w*", relevance: 0 },
      R = { className: "title", begin: "[a-zA-Z_]\\w*", relevance: 0 },
      M = { begin: "\\.\\s*[a-zA-Z_]\\w*", relevance: 0 };
    var T = Object.freeze({
        __proto__: null,
        IDENT_RE: "[a-zA-Z]\\w*",
      ...
      !(function i(r, o) {
        r.compiled ||
          ...
          o &&
            (r.beginKeywords &&
              ((r.begin =
                "\\b(" + r.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)"),
              (r.__onBegin = a)),
            r.begin || (r.begin = /\B|\b/),
            (r.beginRe = e(r.begin)),
          ...
          (r.contains = [].concat(
            ...r.contains.map(function (t) {
              return (function (t) {
                ...
                return t.cached_variants
                  ? t.cached_variants
                  : (function t(e) {
                      return !!e && (e.endsWithParent || t(e.starts));
                    })(t)
                  ? s(t, { starts: t.starts ? s(t.starts) : null })
                  : Object.isFrozen(t)
                  ? s(t)
                  : t;
              })("self" === t ? r : t);
          ...
          (r.matcher = (function (t) {
            ...
            return (
              ...
              t.terminator_end && e.addRule(t.terminator_end, { type: "end" }),
    ...
    function C(t, e) {
      return e ? Number(e) : ((i = t), k.includes(i.toLowerCase()) ? 0 : 1);
      var i;
    }
    const D = n,
      A = s,
    ...
    var B = (function (t) {
      ...
      function p(t, e, i, s) {
            ...
            ? (function () {
                if ("" !== I) {
                  ...
                  if (!t || n[v.subLanguage]) {
                    var e = t
                      ? p(v.subLanguage, I, !0, S[v.subLanguage])
                      : u(I, v.subLanguage.length ? v.subLanguage : void 0);
        ...
        function d(t) {
          t.className && P.openNode(t.className),
            (v = Object.create(t, { parent: { value: v } }));
        }
        function g(t) {
          var e = t[0],
            i = t.rule;
        ...
        function m(t) {
          var e = t[0],
            ...
            n = (function t(e, i) {
              ...
              if (e.endsWithParent) return t(e.parent, i);
            })(v, i);
          if (n) {
            var s = v;
            s.skip
              ? (I += e)
              : (s.returnEnd || s.excludeEnd || (I += e),
                c(),
                s.excludeEnd && (I = e));
            do {
            ...
            return (
              n.starts &&
                (n.endSameAsBegin && (n.starts.endRe = n.endRe), d(n.starts)),
        ...
        function b(e, n) {
          ...
          if (
            ...
            if (((I += a.slice(n.index, n.index + 1)), !r))
              throw (
                (((s = new Error("0 width match regex")).languageName = t),
                (s.badRule = f.rule),
                s)
              );
            return 1;
          }
          if (((f = n), "begin" === n.type)) return g(n);
          if ("illegal" === n.type && !i)
            throw (
              (((s = new Error(
                'Illegal lexeme "' +
        ...
        try {
          for (
            ...
            T++,
              k
                ? (k = !1)
                : ((v.matcher.lastIndex = M), v.matcher.considerAll()),
              (E = v.matcher.exec(a));

          ) {
            (_ = b(a.substring(M, E.index), E)), (M = E.index + _);
          }
          return (
            b(a.substr(M)),
            P.closeAllNodes(),
          ...
          e
            ...
            .forEach(function (e) {
              ...
              (n.language = e),
                ...
                n.relevance > i.relevance && ((s = i), (i = n));
            }),
      ...
      function f(t) {
        ...
        d(o) ||
          (v("before:highlightBlock", { block: t, language: o }),
          l.useBR
          ...
          (i = N(e)).length &&
            ...
            (n.value = O(i, N(a), r))),
          (n.value = m(n.value)),
          v("after:highlightBlock", { block: t, result: n }),
          (t.innerHTML = n.value),
          (t.className = (function (t, e, i) {
            var n = e ? s[e] : i,
              a = [t.trim()];
            return (
              t.match(/\bhljs\b/) || a.push("hljs"),
              t.includes(n) || a.push(n),
              a.join(" ").trim()
            );
          })(t.className, o, n.language)),
          (t.result = { language: n.language, re: n.relevance }),
          n.second_best &&
            (t.second_best = {
      ...
      const w = { disableAutodetect: !0, name: "Plain text" };
      function y(t) {
      ...
      for (const t in T) "object" == typeof T[t] && i(T[t]);
      ...
      return {
        ...
        contains: [
          ...
          },
          {
            ...
            excludeEnd: !0,
            contains: [t.inherit(t.TITLE_MODE, { begin: s }), g],
            illegal: /\[|%/,
          },
          { begin: /\$[(.]/ },
          t.METHOD_GUARD,
          ...
          { beginKeywords: "constructor", end: /\{/, excludeEnd: !0 },
          {
            ...
            keywords: "get set",
            contains: [
              t.inherit(t.TITLE_MODE, { begin: s }),
              { begin: /\(\)/ },
              g,
            ],
          },
  ...
  function (t, e) {
    t.exports = function (t) {
      var e = {
        ...
        n = t.inherit(i, { begin: "\\(", end: "\\)" }),
        s = t.inherit(t.APOS_STRING_MODE, { className: "meta-string" }),
        a = t.inherit(t.QUOTE_STRING_MODE, { className: "meta-string" }),
        r = {
          endsWithParent: !0,
          illegal: /</,
          relevance: 0,
            ...
            var i = (function (t, e) {
              ...
              if (e && "function" == typeof btoa) {
                var s =
                    ...
                    (h = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(
                      o
                    )),
                    "/*# ".concat(h, " */")),
  ...
  function (t, e, i) {
    ...
    class s extends n {
      ...
      draw(t) {
        ...
        e.rotate(this.state.angle),
          e.clip(),
          this.isLoad
            ? e.drawImage(this.image, 0, 0, n, s)
            : this.drawLoader(e, { x: 0, y: 0 }, n, s),
          e.restore();
      }
      simpleDraw(t) {
        const e = this.render.getRect(),
          ...
          r = e.top;
        this.isLoad
          ? i.drawImage(this.image, a, r, n, s)
          : this.drawLoader(i, { x: a, y: r }, n, s);
      }
      drawLoader(t, e, i, n) {
        t.beginPath(),
    ...
    class o {
      ...
      static GetAngleBetweenTwoLine(t, e) {
        ...
        return Math.acos(
          (i * n + s * a) /
            (Math.sqrt(i * i + s * s) * Math.sqrt(n * n + a * a))
        );
      }
      ...
      static LimitPointToCircle(t, e, i) {
        if (o.GetDistanceBetweenTwoPoint(t, i) <= e) return i;
        const n = t.x,
          s = t.y,
          a = i.x,
          r = i.y;
        let h =
          Math.sqrt(
            (Math.pow(e, 2) * Math.pow(n - a, 2)) /
              (Math.pow(n - a, 2) + Math.pow(s - r, 2))
          ) + n;
        i.x < 0 && (h *= -1);
        let l = ((h - n) * (s - r)) / (n - a) + s;
        return n - a + s === 0 && (l = e), { x: h, y: l };
      }
      ...
      static GetIntersectBeetwenTwoLine(t, e) {
        const i = t[0].y - t[1].y,
          ...
          c = -(r * a - o * s) / (i * a - n * s),
          d = -(i * o - n * r) / (i * a - n * s);
        if (isFinite(c) && isFinite(d)) return { x: c, y: d };
        if (Math.abs(h - l) < 0.1) throw new Error("Segment included");
        return null;
      }
      static GetCordsFromTwoPoint(t, e) {
        ...
        for (let o = 1; o <= s; o += 1)
          a.push({ x: r(t.x, e.x, i, s, o), y: r(t.y, e.y, n, s, o) });
        return a;
      }
    }
    class h extends n {
      ...
      drawHard() {
        ...
        0 === this.orientation
          ? ((this.element.style.transformOrigin =
              this.render.getRect().pageWidth + "px 0"),
            (this.element.style.transform =
              "translate3d(0px, 0px, 0) rotateY(" + e + "deg)"))
          : ((this.element.style.transformOrigin = "0 0"),
            (this.element.style.transform =
              "translate3d(" + t + "px, 0px, 0) rotateY(" + e + "deg)")),
      ...
      drawSoft(t) {
        ...
        for (const t of this.state.area)
          if (null !== t) {
            ...
            (i = o.GetRotatedPoint(i, { x: 0, y: 0 }, this.state.angle)),
              (e += i.x + "px " + i.y + "px, ");
          }
        (e = e.slice(0, -2)),
          (e += ")"),
    ...
    class l extends a {
      constructor(t, e, i, n) {
        super(t, e), (this.element = i), (this.pagesElement = n);
      }
      load() {
    ...
    class c {
      ...
      calculateAngle(t) {
        ...
        i < 0 && (n = -n);
        const s = Math.PI - n;
        if (!isFinite(n) || (s >= 0 && s < 0.003))
          throw new Error("The G point is too small");
        return "bottom" === this.corner && (n = -n), n;
      }
      getPageRect(t) {
        return "top" === this.corner
      ...
      calculateIntersectPoint(t) {
        ...
        "top" === this.corner
          ? ((this.topIntersectPoint = o.GetIntersectBetweenTwoSegment(
              e,
            ...
            (this.sideIntersectPoint = o.GetIntersectBetweenTwoSegment(
              e,
            ...
            (this.bottomIntersectPoint = o.GetIntersectBetweenTwoSegment(
              e,
      ...
      checkPositionAtCenterLine(t, e, i) {
        ...
        n !== s && ((n = s), this.updateAngleAndGeometry(n));
        const a = Math.sqrt(
        ...
        if (
          ...
          t !== n && ((n = t), this.updateAngleAndGeometry(n));
        }
        return n;
      }
    ...
    class d {
      ...
      flip(t) {
        ...
        this.calc.calc({ x: e.pageWidth - i, y: n }),
      ...
      start(t) {
        ...
        if (!this.checkDirection(n)) return !1;
        try {
          if (
      ...
      flipToPage(t, e) {
        ...
        try {
          n > i &&
            (this.app.getPageCollection().setCurrentSpreadIndex(n - 1),
            this.flipNext(e)),
            n < i &&
              (this.app.getPageCollection().setCurrentSpreadIndex(n + 1),
              this.flipPrev(e));
      ...
      animateFlippingTo(t, e, i, n = !0) {
        const s = o.GetCordsFromTwoPoint(t, e),
          a = [];
        for (const t of s) a.push(() => this.do(t));
          ...
          "stretch" === this.setting.size
            ? (e < 2 * this.setting.minWidth &&
              ...
              r > this.getBlockHeight() &&
                ((r = this.getBlockHeight()), (a = r * s)),
              (o = "portrait" === t ? i - a / 2 - a : i - a))
            : e < 2 * a &&
              this.app.getSettings().usePortrait &&
              ((t = "portrait"), (o = i - a / 2 - a)),
          (this.boundsRect = {
            left: o,
            top: n - r / 2,
            width: 2 * a,
    ...
    class p extends g {
      ...
      drawBookShadow() {
        ...
        n.addColorStop(0, "rgba(0, 0, 0, 0)"),
          n.addColorStop(0.4, "rgba(0, 0, 0, 0.2)"),
          n.addColorStop(0.49, "rgba(0, 0, 0, 0.1)"),
          n.addColorStop(0.5, "rgba(0, 0, 0, 0.5)"),
          n.addColorStop(0.51, "rgba(0, 0, 0, 0.4)"),
      ...
      drawInnerShadow() {
        ...
        0 === this.shadow.direction
          ? (this.ctx.translate(-n, -100),
            s.addColorStop(1, "rgba(0, 0, 0, " + this.shadow.opacity + ")"),
            s.addColorStop(0.9, "rgba(0, 0, 0, 0.05)"),
            s.addColorStop(0.7, "rgba(0, 0, 0, " + this.shadow.opacity + ")"),
            s.addColorStop(0, "rgba(0, 0, 0, 0)"))
          : (this.ctx.translate(0, -100),
            s.addColorStop(0, "rgba(0, 0, 0, " + this.shadow.opacity + ")"),
            s.addColorStop(0.1, "rgba(0, 0, 0, 0.05)"),
            s.addColorStop(0.3, "rgba(0, 0, 0, " + this.shadow.opacity + ")"),
    ...
    class m extends u {
      constructor(t, e, i, n) {
        ...
        for (const t of n) this.distElement.appendChild(t);
        this.setHandlers();
      }
      updateItems(t) {
    ...
    class b extends g {
      ...
      setShadowData(t, e, i, n) {
        super.setShadowData(t, e, i, n),
          ...
          null === this.hardInnerShadow &&
            ...
            (this.hardInnerShadow.style.zIndex = (
              this.getSettings().startZIndex + 4
            ).toString(10)));
      }
      drawHardInnerShadow() {
      ...
      drawInnerShadow() {
        ...
        (this.innerShadow.style.width = e + "px"),
          ...
          (this.innerShadow.style.transform = `translate3d(${s.x - i}px, ${
            s.y - 100
          }px, 0) rotate(${a}rad)`);
        const r = [
        ...
        for (const t of r) {
          let e =
            1 === this.getDirection()
              ...
              : { x: t.x - this.shadow.pos.x, y: t.y - this.shadow.pos.y };
          (e = o.GetRotatedPoint(e, { x: i, y: 100 }, a)),
            (h += e.x + "px " + e.y + "px, ");
        }
        (h = h.slice(0, -2)),
          (h += ")"),
      ...
      drawOuterShadow() {
        ...
        (this.outerShadow.style.width = this.shadow.width + "px"),
          ...
          (this.outerShadow.style.transform = `translate3d(${e.x - n}px, ${
            e.y - 100
          }px, 0) rotate(${i}rad)`);
        const a = [];
        a.push(
          ...
          if (null !== t) {
            let e =
              1 === this.getDirection()
                ? { x: -t.x + this.shadow.pos.x, y: t.y - this.shadow.pos.y }
                : { x: t.x - this.shadow.pos.x, y: t.y - this.shadow.pos.y };
            (e = o.GetRotatedPoint(e, { x: n, y: 100 }, i)),
              (r += e.x + "px " + e.y + "px, ");
          }
        (r = r.slice(0, -2)),
          (r += ")"),
      ...
      update() {
        super.update(),
          null !== this.rightPage &&
            (this.rightPage.setOrientation(1), this.rightPage.clearSaved()),
          null !== this.leftPage &&
            (this.leftPage.setOrientation(0), this.leftPage.clearSaved());
      }
    }
    class w {
      constructor() {
    ...
    class y extends class {
      ...
      trigger(t, e, i = null) {
        if (this.events.has(t))
          for (const n of this.events.get(t)) n({ data: i, object: e });
      }
    } {
      constructor(t, e) {
        super(),
      ...
      userMove(t, e) {
        this.isUserTouch || e
          ? this.isUserTouch &&
            o.GetDistanceBetweenTwoPoint(this.mousePosition, t) > 5 &&
    ...
    v.a.registerLanguage("javascript", P.a),
      ...
      document.addEventListener("DOMContentLoaded", function () {
        document.getElementById("demoBookExample") &&
          (function () {
              ...
              n.addEventListener("click", (s) => {
                if (n.classList.contains("btn-primary"))
                  (document.querySelector(".source").style.display = "none"),
                    (document.querySelector(".flip-book").style.display =
                      "block"),
                  ...
                  n.classList.add("btn-primary"),
                    ...
                    (document.querySelector(".flip-book").style.display =
                      "none");
                  for (const e of t)
                    e.classList.contains("source-" + n.dataset.dest)
            ...
            e.loadFromHTML(document.querySelectorAll(".page")),
              (document.querySelector(
                ".page-total"
              ).innerText = e.getPageCount()),
              (document.querySelector(
                ".page-orientation"
              ).innerText = e.getOrientation()),
              document
          ...
          document.getElementById("canvasBookExample") &&
            (function () {
              $(".mode").tooltip();
              ...
              t.loadFromImages([
                "images/canvas/473433.jpg",
                "./images/canvas/473433.jpg",
                "./../images/canvas/473433.jpg",
                "./../images/canvas/473433.jpg",
                "canvas/124389.jpg",
                "images/canvas/124405.jpg",
                "images/canvas/124410.jpg",
                "images/canvas/124417.jpg",
                "images/canvas/4.jpg",
                "images/canvas/5.jpg",
                "images/canvas/6.jpg",
                "images/canvas/7.jpg",
              ...
              e.on("flip", (t) => {
                ...
                t.on("flip", (e) => {
                  (document.querySelector(".page-count").innerHTML =
                    ...
                    (document.querySelector(
                      ".page-total"
                    ).innerHTML = t.getPageCount());
                }),
                (document.querySelector(
                  ".page-total"
                ).innerHTML = r.getPageCount());
              ...
              document
                ...
                $(".mode").on("click", function () {
                  return (
                    ...
                    $("#bookParent").removeClass(
                      "pBlock--mobile  pBlock--tablet  pBlock--tablet-l  pBlock--desktop"
                    ),
                    $("#bookParent").addClass(
                      "pBlock--" + $(this).data("dest")
                    ),
                    r.update(),
                    setTimeout(() => {
                      r.getUI().update(), r.update();
                    }, 2),
        ...
        for (const e of t) v.a.highlightBlock(e);
      });
  },
]);
